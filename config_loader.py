...
def load_config(yaml_path: str) -> ViSERConfig:
    ...
    # Root
    exp_name = raw.get("experiment_name", "viser_optimized")
    ...
    config = ViSERConfig(
        ...
        cache_dir  = p.get("cache_dir",  "cache_vi_ser"),
        log_dir    = p.get("log_dir",    "logs_vi_ser"),
        ...
        regional_col      = dat.get("regional_col", "regional"),
        emotion_label_map = dat.get("emotion_label_map",  {"e0":0,"e1":1,"e2":2,"e3":3}),
        regional_label_map= dat.get("regional_label_map", {"north":0,"central":1,"south":2}),
        ...
        # models
        acoustic_model_name   = mod.get("acoustic",   "nguyenvulebinh/wav2vec2-base-vietnamese-250h"),
        phowhisper_model_name = mod.get("phowhisper", "vinai/PhoWhisper-medium"),
        phobert_model_name    = mod.get("phobert",    "vinai/phobert-base"),
        ...
        num_regional_classes   = mod.get("num_regional_classes",   3),
        ...
        freeze_phobert           = frz.get("phobert",           False),
        freeze_teacher           = frz.get("teacher",           True),

        # loss
        alpha_ctc      = lss.get("alpha_ctc",      0.1),
        alpha_kd       = lss.get("alpha_kd",       0.5),
        alpha_distill  = lss.get("alpha_distill",  0.3),
        alpha_regional = lss.get("alpha_regional", 0.2),
        ...
        backbone_lr                 = tr.get("backbone_lr",                 1e-4),
        ...
        wandb_project = log.get("wandb_project", "viser"),
